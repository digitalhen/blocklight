...
export default defineConfig({
  ...
  build: { rollupOptions: { input: { docs: fileURLToPath(new URL('./docs.html', import.meta.url)), main: fileURLToPath(new URL('./index.html', import.meta.url)), react: fileURLToPath(new URL('./react.html', import.meta.url)) } } },
});
